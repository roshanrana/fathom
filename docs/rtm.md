...
| FR-002 | 02-hld.md: Critical flows | T-001(done), T-016(done) | tests\test_app.py, tests\test_quotes.py | — | covered |
| FR-003 | — | T-001(done) | tests\test_quotes.py | — | covered |
| FR-004 | — | T-002(done) | tests\test_filings.py | — | covered |
| FR-005 | — | T-002(done), T-013(done) | tests\test_filings.py | — | covered |
| FR-006 | — | T-006(done), T-014(done), T-016(done) | tests\test_app.py, tests\test_briefing.py | — | covered |
| FR-007 | — | T-005(done), T-006(done) | tests\test_briefing.py, tests\test_contracts.py | — | covered |
| FR-008 | 02-hld.md: Critical flows; 02-threat-model.md: STRIDE table | T-005(done), T-013(done) | tests\test_guard.py | — | covered |
...
| NFR-002 | 02-hld.md: NFR design | T-015(done) | — | — | NO TEST (G7 blocker) |
...
| NFR-007 | 02-hld.md: NFR design | T-006(done), T-010(done), T-013(done) | tests\test_bench.py, tests\test_briefing.py | — | covered |
